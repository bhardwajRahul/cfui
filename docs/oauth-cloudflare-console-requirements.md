...
- KV namespace 创建/重命名/删除，key 列表、已加载 key 批量删除、UTF-8 value 查看/编辑/删除、文本 key 创建。
...
| Storage / KV | Namespace/key list, value create/edit/delete | Namespace create/rename/delete, key list, loaded-key bulk delete, UTF-8 value create/edit/delete | Optional binary value workflows |
