...
- KV namespace 创建/重命名/删除，key 列表、UTF-8 value 查看/编辑/删除、文本 key 创建。
...
| Storage / KV | Namespace/key list, value create/edit/delete | Namespace create/rename/delete, key list, UTF-8 value create/edit/delete | Optional bulk key operations and binary value workflows |
