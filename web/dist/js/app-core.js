...
(() => {
    ...
    const state = {
        ...
        oauth: {
            ...
            validationError: '',
            validationReports: [],
            validationReportsLoading: false,
            validationReportsError: '',
            validationArchiveSaving: false,
            validationArchiveLoadingId: '',
            validationArchiveDeletingId: '',
            accounts: [],
            accountsSession: null,
            accountsCapabilities: null,
            accountsError: '',
            zones: [],
            zonesSession: null,
            zonesCapabilities: null,
            zonesError: '',
            dnsRecords: [],
            dnsSession: null,
            dnsCapabilities: null,
            dnsRecordsError: '',
            dnsMutationError: '',
            tunnels: [],
            localTunnelProfiles: [],
