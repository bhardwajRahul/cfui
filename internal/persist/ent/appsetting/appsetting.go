...
const (
	...
	// FieldActiveTunnelKey holds the string denoting the active_tunnel_key field in the database.
...
var (
	...
	// DefaultActiveTunnelKey holds the default value on creation for the "active_tunnel_key" field.
...
// ByActiveTunnelKey orders the results by the active_tunnel_key field.
func ByActiveTunnelKey(opts ...sql.OrderTermOption) OrderOption {
	return sql.OrderByField(FieldActiveTunnelKey, opts...).ToFunc()
}
...
func ByOauthRelayCallbackURL(opts ...sql.OrderTermOption) OrderOption {
	return sql.OrderByField(FieldOauthRelayCallbackURL, opts...).ToFunc()
}
